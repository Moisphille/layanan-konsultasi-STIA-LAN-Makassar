...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1753004481ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>localhost:5080 / 127.0.0.1 | phpMyAdmin 5.1.3</title>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=stialan_form&table=requestor">`stialan_form`.`requestor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agenda&table=users">`agenda`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agenda&table=events">`agenda`.`events`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ludy_agenda&table=user">`ludy_agenda`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ludy_agenda&table=info">`ludy_agenda`.`info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agenda&table=tasks">`agenda`.`tasks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranqsite&table=communications">`tranqsite`.`communications`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=library&table=users">`library`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpdasar&table=mahasiswa">`phpdasar`.`mahasiswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranqsite&table=users">`tranqsite`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="35543121424c347823574a7279306465">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="stialan_form" targettable="requestor">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `requestor`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="stialan_form" targettable="requestor">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `requestor`  
ORDER BY `requestor`.`reqID` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="stialan_form" targettable="requestor">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="stialan_form" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">USE stialan_form;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="stialan_form" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DROP DATABASE stialan_form;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="stialan_form" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE requestor(
	reqID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    nama VARCHAR(255) NOT NULL,
	identitas CHAR(25) NOT NULL,
